...
export type IBookingSchema = IStepOneGuestFormSchema &
  IStepTwoBookingFormSchema;
export type IStepOneGuestFormSchema = yup.InferType<
  typeof StepOneGuestFormSchema
>;
export type IStepTwoBookingFormSchema = yup.InferType<
  typeof StepTwoBookingFormSchema
>;
...
export const StepTwoBookingFormSchema = yup.object({
